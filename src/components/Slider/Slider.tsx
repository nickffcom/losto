...
import SwiperCore, { Navigation, Autoplay, EffectCreative } from 'swiper'
          ...
          >
            <div className='flex h-full items-center justify-around'>
              <div className='text-center'>
                ...
                <h2 className='mt-2 text-7xl'>Exclusive Steel Frame</h2>
          ...
          >
            <div className='flex h-full items-center justify-around'>
              ...
              <div className='text-center text-white'>
                ...
                <h2 className='mt-2 text-7xl'>Zania Black Edition</h2>
                <Link to={path.productlist} title='Shop Now'>
                  <motion.div
                    initial={{ opacity: 0, y: -20 }}
                    animate={{ opacity: 1, y: 0 }}
          ...
          >
            <div className='flex h-full items-center justify-around'>
              ...
              <div className='text-center text-white'>
                ...
                <h2 className='mt-2 text-7xl'>Full Screen Display</h2>
                <Link to={path.productlist} title='Shop Now'>
                  <motion.div
                    initial={{ opacity: 0, y: -20 }}
                    animate={{ opacity: 1, y: 0 }}
